    ...
    extends Transakcija<T, S> implements Devizna
{
    ...
    /**
     * Inicijalizira podatak o id-u, polaznom računu, dolaznom računu i iznosu transakcije.
     *
     ...
     * @param iznos podatak o iznosu transakcije
     */
    public DeviznaTransakcija(Integer id, T polazniRacun, S dolazniRacun, BigDecimal iznos)
    {
        super(id, polazniRacun, dolazniRacun, iznos);
    }    
